...
@interface ATImgPreView () <UIScrollViewDelegate>
...
//       [imageView sd_setImageWithURL:[NSURL URLWithString:image] placeholderImage:DEF_DEFAULPLACEHOLDIMG];
...
{
    [NSRunLoop cancelPreviousPerformRequestsWithTarget:self.worksVc];
